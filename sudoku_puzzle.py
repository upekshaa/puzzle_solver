...
# TO DO
# may have to account for failure when we are given the same value (twice or more) in a row, column or subsquare
...
class SudokuPuzzle(Puzzle):
    ...
    def fail_fast(self):
        ...
        this is an override of the fail_fast function from puzzle.py

        @param self SudokuPuzzle: this SudokuPuzzle
        @rtype: bool
